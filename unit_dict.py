...
CHARA_NAME = {
    ...
    1251: ["珠希(咖啡馆)", "タマキ(カフェ)", "Tamaki(Cafe)", "猫咖", "咖啡猫", "咖猫剑"],
    1252: ["莫妮卡(咖啡馆)", "モニカ(カフェ)", "Monika(Cafe)", "莫妮咖", "咖二力", "猫二力"],
    ...
    1256: ["碧卡拉", "ビカラ", "Vikala", "鼠鼠", "鼠大将", "鼠妹"],
    1257: ["花凛(炼金术士)", "カリン(アルケミスト)", "Karin(Alchemist)", "绿术", "绿发术士", "炼金恶魔"],
    1258: ["莉莉(堕天使)", "リリ(フォールン)", "Riri(Fallen)", "莉莉"],

    1260: ["可璃亚(堕天使)", "クリア(フォールン)", "Quria(Fallen)", "可璃亚"],
    1261: ["普蕾西亚(堕天使)", "プレシア(フォールン)", "Precia(Fallen)", "普蕾西亚", "猪妹"],
    1262: ["伊莉亚(祭服)", "イリヤ(儀装束)", "Ilya(Costume)", "礼装伊莉亚", "礼装伊莉雅", "礼装伊利亚", "礼装yly", "礼服伊莉亚", "礼服伊莉雅", "礼服伊利亚", "礼服yly", "礼亚"],
    1263: ["雪(祭服)", "ユキ(儀装束)", "Yuki(Costume)", "礼雪", "礼服雪", "礼服雪哥"],
    1264: ["克萝茜", "クローチェ", "Croce", "机娘"], 
    1265: ["莱拉耶尔", "ライラエル", "Lyrael", "傲慢", "傲慢姬"],
    ...
    1272: ["凯留(编入生)", "キャル(編入生)", "Kyaru(Transfer Student)", "学猫", "偷腥猫"],
    1273: ["铃奈(编入生)", "スズナ(編入生)", "Suzuna(Transfer Student)", "学暴", "雪豹"],

    1275: ["咲恋(莎拉沙利亚)", "サレン(サラサリア)", "Saren(Salasaria)", "火电", "火电站", "火舞旋风"],
    1276: ["流夏(莎拉沙利亚)", "ルカ(サラサリア)", "Ruka(Salasaria)", "流沙", "沙漠流夏"],


    1279: ["贪吃佩可(圣诞节)", "ペコリーヌ(クリスマス)", "Pecorine(Christmas)", "圣吃", "剩饭", "圣诞吃货", "圣诞佩可"],
    1280: ["克蕾琪塔(圣诞节)", "クレジッタ(クリスマス)", "Creditta(Christmas)", "圣诞富婆", "圣婆"],
